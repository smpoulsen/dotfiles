...
you should place your code here."
  ...
  (setq exec-path (append
                   exec-path '("~/node_modules/.bin" "~/.nix-profile/bin" "~/.local/bin" "~/.asdf/shims/bundler")))
